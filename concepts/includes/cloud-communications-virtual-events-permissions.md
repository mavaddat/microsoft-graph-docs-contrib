...
| VirtualEventRegistration-Anon.ReadWrite.Chat | [Virtual event registrations](/graph/api/resources/virtualeventregistration) | Register attendees and cancel registrations for this webinar or townhall. |
