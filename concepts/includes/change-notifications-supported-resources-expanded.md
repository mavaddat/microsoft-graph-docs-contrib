...
Copilot [aiInsights][]| Copilot AI insights of a meeting that a particular user is part of: `/copilot/users/{user-id}/onlineMeetings/getAllAiInsights` <br><br> Copilot AI insights for a particular meeting: `/copilot/users/{user-id}/onlineMeetings/{online-meeting-id}/aiInsights`| TBH |
...
[aiInsights]: /graph/api/resources/aiinsights/graph
