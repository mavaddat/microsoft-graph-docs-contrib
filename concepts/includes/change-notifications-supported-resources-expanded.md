...
> | Copilot [aiInsights][]| Copilot AI insights from meetings that a particular user is part of: `/copilot/users/{userId}/onlineMeetings/getAllAiInsights` <br><br> Copilot AI insights for a particular meeting: `/copilot/users/{userId}/onlineMeetings/{onlineMeetingId}/aiInsights`| Maximum subscription quotas for AI insights across all meetings for a user: <ul><li> Per app and user combination : 1 <li> Per user (delegated): 10 <li> Per organization: 10,000 total subscriptions. <br><br> Maximum subscription quotas for AI insights of a specific meeting: <li> Per app and user + meeting combination: 1</li> <li> Per user and meeting combination (delegated): 1</li> <li> Per organization: 10,000 total subscriptions (shared)</li></ul> |
