...
> [!IMPORTANT]
> If any of the federated credential fields are set incorrectly, the connection fails. Verify that the **Issuer**, **Subject**, and **Name** values match the managed identity values exactly.
