...
Using the new [profilepropertysetting](/graph/api/resources/profilepropertysetting) APIs, tenant administrators can configure tenant-level settings for profile properties.
