...
Represents a keyed collection of [sharePointIdentity][] resources and identity resources. This resource extends from the **identitySet** resource to provide the ability to expose SharePoint-specific information to the user.
