...
|[Create or update permissions in bulk](../api/filestoragecontainer-patch-permissions.md)|[permission](../resources/permission.md) collection|Perform delta patch to create or update up to 10 [permission](../resources/permission.md) objects on a [fileStorageContainer](../resources/filestoragecontainer.md) in a single request.|
