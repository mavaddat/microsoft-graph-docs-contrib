...
| [List activities](../api/itemactivity-list.md)  | [itemActivity](../resources/itemactivity.md) collection                         | List the recent activities that took place on an item or under a hierarchy.                                                      |
