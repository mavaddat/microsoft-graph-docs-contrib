...
Represents a recording associated with an [online meeting](onlinemeeting.md) or an [ad hoc call](adhoccall.md).
...
|[Get recordings initiated by a specified user](../api/adhoccall-getallrecordings.md) | [callRecording](callrecording.md) collection | Get the [callRecording](callrecording.md) objects from [adhoc call](../resources/adhoccall.md) instances that a specific user initiates.|
