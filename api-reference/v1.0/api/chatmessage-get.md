...
### Example 7: Get a chat message with a code block
...
```msgraph-interactive
GET https://graph.microsoft.com/v1.0/chats/19:e2ed97baac8e4bffbb91299a38996790@thread.v2/messages/1741124579808
```
