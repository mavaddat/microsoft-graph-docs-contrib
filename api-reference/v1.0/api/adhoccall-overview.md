...
#customer intent: As a developer, I want to understand the properties of the `adhocCall` resource type so that I can effectively manage ad hoc call data in my application.
author: "kanchm"
