...
Get all recordings from [adhoc call](../resources/adhoccall.md) instances that a specific user initiates. This API enables you to programmatically access and analyze meeting recordings for calls organized by a given user, filtered by optional date ranges.
...
[!INCLUDE [permissions-table](../../v1.0/includes/permissions/adhoccall-getallrecordings-permissions.md)]
