...
> [!NOTE]
> This request might have replication delays for groups that were recently created, updated, or deleted. Recently created or updated groups might not appear in results immediately. Retry the request after a brief delay. For more information, see [Designing for Eventual Consistency for Microsoft Entra](https://learn.microsoft.com/entra/architecture/guide-id-secure-development-best-practices#designing-for-eventual-consistency).
