...
Represents an invitation sent by a governing tenant to establish a governance relationship with a governed tenant. Invitations provide an alternative mechanism to [governanceRequest](tenantgovernanceservices-governancerequest.md) for initiating governance relationships.
