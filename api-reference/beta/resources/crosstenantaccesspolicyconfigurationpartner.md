...
| blockServiceProviderOutboundAccess | Boolean | Specifies whether granular delegated admin privileges (GDAP) tokens should be issued for users going outbound into another organization. Default value is `false`. |
