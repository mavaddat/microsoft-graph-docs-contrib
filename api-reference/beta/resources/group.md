...
| onPremisesExtensionAttributes | [onPremisesExtensionAttributes](../resources/onpremisesextensionattributes.md)  | Complex type containing extension attributes 1-15 for the group, synchronized from on-premises Active Directory. Supports `$filter` (`eq`, `ne`, `not`, `in`) For example, `$filter=onPremisesExtensionAttributes/extensionAttribute1 eq 'Department-Marketing`.|
