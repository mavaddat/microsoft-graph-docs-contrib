...
|tokenProtectionStatusDetails|[tokenProtectionStatusDetails](../resources/tokenprotectionstatusdetails.md)|The status of the token protection for a request in the sign-in logs. For more information, see [Conditional Access: Token Protection](/entra/identity/conditional-access/concept-token-protection).| in sign file 
