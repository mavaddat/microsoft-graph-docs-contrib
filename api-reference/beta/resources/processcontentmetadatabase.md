...
| contentCategory  | [contentCategory](../resources/contentCategory.md)                             | Indicates the type of content (for example, whether it comes from an AI source).  Default value is AI.            |
