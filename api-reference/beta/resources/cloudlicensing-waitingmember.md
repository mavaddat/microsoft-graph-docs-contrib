...
|[Get waiting member for user](../api/cloudlicensing-usercloudlicensing-list-waitingmember.md)|[microsoft.graph.cloudLicensing.waitingMember](../resources/cloudlicensing-allotment.md) collection|Get waiting members for a specific user.|
