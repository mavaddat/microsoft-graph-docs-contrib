...
| recordType | microsoft.graph.security.auditLogRecordType | The type of audit log record. For content activity, it is set to 328 by default, and 410 for enforcement result |
