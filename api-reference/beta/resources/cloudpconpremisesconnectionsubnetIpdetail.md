...
description: "Describes the subnet IP details of a Cloud PC Azure network connection."
author: "shijun2026-3"
...
Describes the subnet IP details of a [cloudPcOnPremisesConnection](../resources/cloudpconpremisesconnection.md).
