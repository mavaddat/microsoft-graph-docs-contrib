...
|approverInformationVisibility|[approverInformationVisibility](approverinformationvisibility.md)|Indicates whether approver information is visible to the requestor. The possible values are: `default`, `notVisible`, `visible`, `unknownFutureValue`.|
