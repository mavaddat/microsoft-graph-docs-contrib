...
|:---|:---|:---|
| cloudLicensing | [microsoft.graph.cloudLicensing.adminCloudLicensing](../resources/cloudlicensing-admincloudlicensing.md) | Represents the root of the cloud licensing API for the entire organization. Read-only. |
