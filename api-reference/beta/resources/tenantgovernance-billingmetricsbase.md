...
> [!IMPORTANT]
> This is an abstract base type and does not appear directly in API responses. Use the concrete types [billingMetricsInitial](tenantgovernance-billingmetricsinitial.md) or [billingMetricsRecent](tenantgovernance-billingmetricsrecent.md).
