...
> [!CAUTION]
> The **cloudPcReports** resource is deprecated and stop returning data on December 31, 2026. Going forward, use the [cloudPcReport](cloudpcreport.md) resource instead.
