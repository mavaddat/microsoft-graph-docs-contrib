...
|[Patch permissions](../api/filestoragecontainer-patch-permissions.md)|[permission](../resources/permission.md) collection|Manage permissions on a fileStorageContainer in bulk using delta patch.|
