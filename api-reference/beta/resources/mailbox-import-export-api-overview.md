...
These APIs support access to data in users' primary mailboxes, shared mailboxes and archive on Exchange Online. Items can be imported to the same mailbox or a different one.
