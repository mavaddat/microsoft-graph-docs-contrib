...
|contentCategory   |microsoft.graph.contentCategory                                                 | The type of content. Values include `none` and `ai`.  The default value is `ai`, which refers to AI generated content. Inherited from [processContentMetadataBase](../resources/processcontentmetadatabase.md).|
