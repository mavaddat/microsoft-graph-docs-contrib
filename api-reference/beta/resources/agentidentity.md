...
|inheritedAppRoleAssignments|[appRoleAssignment](../resources/approleassignment.md) collection|Application role assignments that this agent identity inherits from its parent agent identity blueprint principal. Read-only. Nullable.|
|inheritedOauth2PermissionGrants|[oAuth2PermissionGrant](../resources/oauth2permissiongrant.md) collection|Delegated permission grants that this agent identity inherits from its parent agent identity blueprint principal. Read-only. Nullable.|
