...
Create a new license [microsoft.graph.cloudLicensing.assignment](../resources/cloudlicensing-assignment.md) by posting to the organization's assignments collection.
