...
|[aiInsights](/microsoft-365-copilot/extensibility/api/ai-services/meeting-insights/callaiinsight-get?pivots=graph-preview)  <br /> `/copilot/users/{userId}/onlineMeetings/getAllAiInsights` <br /> Copilot AI insights from meetings that a particular user is part of. | OnlineMeetingAiInsight.Read.All    | Not supported.  | OnlineMeetingAiInsight.Read.All |
|[aiInsights](/microsoft-365-copilot/extensibility/api/ai-services/meeting-insights/callaiinsight-get?pivots=graph-preview) <br/> `/copilot/users/{userId}/onlineMeetings/{onlineMeetingId}/aiInsights` <br/> Copilot AI insights for a particular meeting. | OnlineMeetingAiInsight.Read.All    | Not supported.  | OnlineMeetingAiInsight.Read.All |
