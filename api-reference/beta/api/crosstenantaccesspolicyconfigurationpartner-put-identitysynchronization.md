...
description: "Create a cross-tenant user or group synchronization policy for a partner-specific configuration."
author: "rolyon"
...
Create a cross-tenant user or group synchronization policy for a partner-specific configuration.
