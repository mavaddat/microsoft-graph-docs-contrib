...
<!-- {
  ...
  "name": "cloudlicensing-groupcloudlicensing-post-assignments-permissions"
}
-->
[!INCLUDE [permissions-table](../includes/permissions/cloudlicensing-groupcloudlicensing-post-assignments-permissions.md)]
...
<!-- {
  "blockType": "request",
  "name": "create_assignment_from_group"
}
-->
``` http
POST https://graph.microsoft.com/beta/groups/6d645c5f-089f-40d8-b0e7-136fb5c56d5b/cloudLicensing/assignments
