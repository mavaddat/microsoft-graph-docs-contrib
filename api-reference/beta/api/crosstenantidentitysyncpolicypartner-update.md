...
description: "Update the user or group synchronization policy of a partner-specific configuration."
author: "rolyon"
...
Update the user or group synchronization policy of a partner-specific configuration.
...
|:---|:---|:---|
|displayName|String|Display name for the cross-tenant user or group synchronization policy. Generally, this should be the tenant name of the partner Microsoft Entra organization. Optional.|
