...
Update the **canReceiveInvitations** property of the [tenantGovernanceSetting](../resources/tenantgovernance-tenantgovernancesetting.md) singleton. This property controls whether the tenant can receive governance invitations.
...
<!-- {
  ...
  "name": "tenantgovernanceservices-tenantgovernancesetting-update-permissions"
}
-->
[!INCLUDE [permissions-table](../includes/permissions/tenantgovernance-tenantgovernancesetting-update-permissions.md)]
...
If successful, this method returns a `200 OK` response code and an updated [microsoft.graph.tenantGovernanceServices.tenantGovernanceSetting](../resources/tenantgovernance-tenantgovernancesetting.md) object in the response body.
