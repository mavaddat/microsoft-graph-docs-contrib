...
Delete a [governanceInvitation](../resources/tenantgovernance-governanceinvitation.md) object.
...
-->
``` http
DELETE https://graph.microsoft.com/beta/directory/tenantGovernance/governanceInvitations/{governanceInvitationId}
```
